...
""));
        ...
        frame = new QFrame(ClientForm);
        frame->setObjectName("frame");
        frame->setFrameShape(QFrame::Shape::StyledPanel);
        frame->setFrameShadow(QFrame::Shadow::Raised);

        gridLayout_2->addWidget(frame, 2, 3, 1, 1);
        ...
        label_sector->setStyleSheet(QString::fromUtf8("background-color: transparent;"));
        ...
        searchGroupBox->setEnabled(true);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        searchCriteriaComboBox->setItemText(3, QCoreApplication::translate("MainWindow", "time", nullptr));
